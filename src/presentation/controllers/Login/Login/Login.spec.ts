...
import { mockAuthenticationParams } from '@/domain/test/mockAccount';
...
import { AuthenticationSpy } from '@/presentation/test/mockAccount';
import { ValidationSpy } from '@/presentation/test/mockValidation';
